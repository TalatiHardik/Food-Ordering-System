    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Bill Full Details</h4></center>
            </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                while($drow=$dquery->fetch_array()){
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo "Rs "; ?> <?php echo number_format($drow['price'], 2); ?></td>
                                        <td><?php echo $drow['quantity']; ?></td>
                                        <td class="text-right"><?php echo "Rs "; ?>
                                            <?php
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?php echo "Rs "; ?> <?php echo number_format($row['total'], 2); ?></td>
                            </tr>
                        </tbody>
                    </table>
